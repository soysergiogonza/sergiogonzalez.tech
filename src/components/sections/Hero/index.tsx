				...
				<div
					...
					<div>
						...
						<h2 className="text-base font-light text-white">
							FullStack Developer | Software Architect | Design Patterns | HTML | CSS | JavaScript | TypeScript |
							Node.js | Express | React.js | Next.js | Redux | Git | GitHub | Azure | Playwright | React Query | Hook
							Form | SCRUM
						</h2>
					</div>
				</div>
